...
/**
 * Builder created to give users a friendly way of adding groups to a
 * report.</br>
 * </br>
 * Usage example: </br>
 * GroupBuilder gb1 = new GroupBuilder(); ColumnsGroup g1 =
 * gb1.addCriteriaColumn((PropertyColumn) columnState)</br>
...
public class GroupBuilder {
    ...
    public GroupBuilder addHeaderVariable(AbstractColumn column, DJCalculation operation, Style style,
            DJValueFormatter formatter, DJGroupLabel glabel1) {
    ...
    /**
     * Registers a variable for later reference inside custom expressions. The new
     * variable will perform the calculation using the field information passed in
     * the ColumnProperty parameter. Such ColumnProperty will be properly registered
     * in the report design as a field ($F{...})
     * 
     * 
     * @param name
     * @param property
    ...
    /***
     * pass-through property to setup group header and footer bands "allowSplit"
     * property. When FALSE, if the content reaches end of the page, the whole band
    ...
    /**
     * Footer labels are placed at the right of of the footer variables. It should
     * be used as a general footer to describe variables
     * 
     * @param label
     * @return
     */
    ...
    /**
     * height for values shown in group footer such as calculations, current value,
     * etc.
     * 
     * @param height
     * @return
    ...
    /**
     * height for values shown in group header such as calculations, current value,
     * etc.
     * 
     * @param height
     * @return
