...
/**
 * Builder created to give users an easy way of creating a DynamicReport based
 * on a collection.</br>
 * </br>
 * Usage example: </br>
 * DynamicReport report = new ReflectiveReportBuilder(data, new
 * String[]{"productLine", "item", "state", "id", "branch", "quantity",
 * "amount"}) .addGroups(3).build(); </br>
...
public class ReflectiveReportBuilder extends FastReportBuilder {
    ...
    /**
     * Takes the first item in the collection and adds a column for every property
     * in that item.
     * 
     * @param _data
     *            the data collection. A not null and nor empty collection should be
     *            passed.
     */
     ...
     *            the data collection. A not null and nor empty collection should be
     *            passed.
     * @param _propertiesNames
     *            and array with the names of the desired properties.
     */
     ...
     * 
     * @param _properties
     *            the array of <code>PropertyDescriptor</code>s to be added.
