...
public class DJGroupLabel extends DJLabel {
    ...
    public DJGroupLabel(CustomExpression labelExpression, Style labelStyle, LabelPosition labelPosition) {
    ...
    public DJGroupLabel(String text, Style labelStyle, LabelPosition labelPosition) {
