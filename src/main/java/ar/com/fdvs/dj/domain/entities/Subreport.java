...
public class Subreport extends DJBaseElement {
    ...
    /**
     * List<SubreportParamter> The objects from the parent report that will be
     * visible as parameters in the subreport
     */
    ...
    /**
     * This expression should point to a java.util.Map object which will be use as
     * the parameters map for the subreport
     */
    private String parametersExpression;

    /**
     * Tells if the parameters maps origin is a parameter of the parent report, or a
     * value of the current row (field)<br>
     * It's value must be SUBREPORT_PARAMETER_MAP_ORIGIN_PARAMETER or
     * SUBREPORT_PARAMETER_MAP_ORIGIN_FIELD
     */
