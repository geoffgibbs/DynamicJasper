...
public abstract class AbstractChartBuilder<T extends AbstractChartBuilder> {
    ...
    /**
     * Sets a bunch of parameters from a DJChartOptions object. This overwrites
     * every other option included in DJChartOptions set trough the builder's setter
     * methods.
     *
     **/
    ...
    public abstract T setPadding(int padding); /*
                                                * { this.chart.getOptions().setPadding(new Integer(padding)); return
                                                * (T) this; }
                                                */
