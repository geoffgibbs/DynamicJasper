...
public class ImageColumn extends ExpressionColumn {
    ...
    public String getTextForExpression() {
        ...
        if (getExpression() != null) {
            ...
            String stringExpression = ExpressionUtils.createCustomExpressionInvocationText(getExpression(),
        ...
        throw new DJException(
                "Neither a CustomExpression or a ColumnProperty was set for colulm \"" + getName() + "\"");
