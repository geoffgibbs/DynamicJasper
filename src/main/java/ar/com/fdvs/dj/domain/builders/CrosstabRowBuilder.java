...
public class CrosstabRowBuilder {
    ...
    public CrosstabRowBuilder setOrder(BucketOrder order) {
        row.setOrder(order);
        return this;
    }
    ...
    /**
     * DJCrosstabRow row = new DJCrosstabRow(); row.setProperty(new
     * ColumnProperty("productLine",String.class.getName()));
     * row.setHeaderWidth(100); row.setHeight(30); row.setTitle("Product Line my
     * mother teressa"); row.setShowTotals(true); row.setTotalStyle(totalStyle);
