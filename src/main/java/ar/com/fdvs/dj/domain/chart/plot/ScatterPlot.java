...
public class ScatterPlot extends AbstractPlot {
    ...
    public void transform(DynamicJasperDesign design, JRChartPlot plot, String name) {
        ...
        if (xAxisLabelExp != null) {
            JRDesignExpression exp = ExpressionUtils.createAndRegisterExpression(design, "xAxisLabel_" + name,
                    xAxisLabelExp);
        ...
        if (xAxisRangeMinValueExp != null) {
            JRDesignExpression exp = ExpressionUtils.createAndRegisterExpression(design, "xAxisRangeMinValue_" + name,
                    xAxisRangeMinValueExp);
        ...
        if (xAxisRangeMaxValueExp != null) {
            JRDesignExpression exp = ExpressionUtils.createAndRegisterExpression(design, "xAxisRangeMaxValue_" + name,
                    xAxisRangeMaxValueExp);
        ...
        if (yAxisLabelExp != null) {
            JRDesignExpression exp = ExpressionUtils.createAndRegisterExpression(design, "yAxisLabel_" + name,
                    yAxisLabelExp);
        ...
        if (yAxisRangeMinValueExp != null) {
            JRDesignExpression exp = ExpressionUtils.createAndRegisterExpression(design, "yAxisRangeMinValue_" + name,
                    yAxisRangeMinValueExp);
        ...
        if (yAxisRangeMaxValueExp != null) {
            JRDesignExpression exp = ExpressionUtils.createAndRegisterExpression(design, "yAxisRangeMaxValue_" + name,
                    yAxisRangeMaxValueExp);
