...
public class TimeSeriesPlot extends AbstractPlot {
    ...
    public void transform(DynamicJasperDesign design, JRChartPlot plot, String name) {
        ...
        if (timeAxisLabelExp != null) {
            JRDesignExpression exp = ExpressionUtils.createAndRegisterExpression(design, "timeAxisLabel_" + name,
                    timeAxisLabelExp);
        ...
        if (timeAxisRangeMinValueExp != null) {
            JRDesignExpression exp = ExpressionUtils.createAndRegisterExpression(design,
                    "timeAxisRangeMinValue_" + name, timeAxisRangeMinValueExp);
        ...
        if (timeAxisRangeMaxValueExp != null) {
            JRDesignExpression exp = ExpressionUtils.createAndRegisterExpression(design,
                    "timeAxisRangeMaxValue_" + name, timeAxisRangeMaxValueExp);
