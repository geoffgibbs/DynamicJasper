...
public class DJChartOptions extends DJBaseElement {
    ...
    public DJChartOptions() {
        ...
        showLabels = true;
        border = 1;
        colors = DJChartColors.simpleColors();
        useColumnsAsCategorie = false;
    }

    public DJChartOptions(boolean showLegend, Color backColor, int height, int width, boolean centered, byte position,
            int y, int x, boolean showLabels, byte border, List colors) {
