...
public class TimeSeriesDataset extends AbstractDataset {
    ...
    /**
     * Gets the time period class (YEAR, QUARTER, MONTH, WEEK, DAY, HOUR, MINUTE,
     * SECOND, MILLISECOND).
     * 
    ...
    /**
     * Sets the time period class (YEAR, QUARTER, MONTH, WEEK, DAY, HOUR, MINUTE,
     * SECOND, MILLISECOND). Default DAY
     * 
