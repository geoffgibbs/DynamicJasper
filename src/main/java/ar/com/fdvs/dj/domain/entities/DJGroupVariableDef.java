...
/**
 * This class is meant for variable registration purposes only. No graphical
 * elements come out from this (compared to DJGroupVariable)
 * 
 * a DJGroupVariableDef is later a registered as a JRVariable which can be
 * referenced upon its name.
 * 
 * @author mamana
 *
 */
