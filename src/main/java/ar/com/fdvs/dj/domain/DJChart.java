...
public class DJChart extends DJBaseElement {
    ...
    // public static final byte LINE_CHART = JRDesignChart.CHART_TYPE_LINE; //not
    // yet... to much to think left
    ...
    public DJChart(byte type, DJGroup columnsGroup, AbstractColumn column, byte operation,
    ...
    public DJChart(byte type, DJGroup columnsGroup, List<AbstractColumn> columns, byte operation,
            DJChartOptions chartOptions) {
        this.type = type;
        this.columnsGroup = columnsGroup;
