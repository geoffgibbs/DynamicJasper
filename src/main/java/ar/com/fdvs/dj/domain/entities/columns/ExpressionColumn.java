...
public class ExpressionColumn extends SimpleColumn {
    ...
    public String getTextForExpression() {
        ...
        if (calculatedExpressionText != null) {
            return calculatedExpressionText;
        }

        String stringExpression = ExpressionUtils.createCustomExpressionInvocationText(expression,
                getColumnProperty().getProperty(), false);

        log.debug("Expression for CustomExpression = " + stringExpression);

        calculatedExpressionText = stringExpression;
        return stringExpression;
    }

    public String getTextForExpressionForCalculartion() {

        String stringExpression = ExpressionUtils.createCustomExpressionInvocationText(expressionForCalculation,
                getColumnProperty().getProperty() + "_calc", false);
