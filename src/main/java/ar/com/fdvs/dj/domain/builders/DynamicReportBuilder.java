 ...
 * .addColumn(column1).addColumn(column2).build(); </br>
...
public class DynamicReportBuilder {
     ...
     * "Created on 07/25/2007", etc. <br>
     * The parameters are all constants from the
     * <code>ar.com.fdvs.dj.domain.AutoText</code> class
     *
     * @param type
     *            One of these constants: <br>
     *            AUTOTEXT_PAGE_X_OF_Y <br>
     *            AUTOTEXT_PAGE_X_SLASH_Y <br>
     *            AUTOTEXT_PAGE_X, AUTOTEXT_CREATED_ON <br>
     *            AUTOTEXT_CUSTOM_MESSAGE
     * @param position
     *            POSITION_HEADER or POSITION_FOOTER
     * @param alignment
     *            <br>
     *            ALIGMENT_LEFT <br>
     *            ALIGMENT_CENTER <br>
     ...
     * @param pattern
     *            only for dates: <br>
     *            PATTERN_DATE_DATE_ONLY <br>
     *            PATTERN_DATE_TIME_ONLY <br>
     ...
     *            PATTERN_DATE_DATE_TIME
     * @param width
     *            with of the autotext. If autotext is of the type
     *            AUTOTEXT_PAGE_X_OF_Y or AUTOTEXT_PAGE_X_SLASH_Y then is the width
     *            of the first part
     * @param width2
     *            If autotext is of the type AUTOTEXT_PAGE_X_OF_Y or
     *            AUTOTEXT_PAGE_X_SLASH_Y, this defines the width given to the
     *            "total page" variable
     * @return
     */
    public DynamicReportBuilder addAutoText(byte type, byte position, byte alignment, byte pattern, int width,
            int width2) {
        HorizontalBandAlignment alignment_ = HorizontalBandAlignment.buildAligment(alignment);
    ...
    public DynamicReportBuilder addAutoText(byte type, byte position, byte alignment, int width, int width2,
            int pageOffset, boolean useI18n, Style style) {
        HorizontalBandAlignment alignment_ = HorizontalBandAlignment.buildAligment(alignment);
        AutoText text = new AutoText(type, position, alignment_);
    ...
    /**
     * Adds a custom fixed message (literal) in header or footer. The message width
     * will be the page witdth<br>
     * The parameters are all constants from the
     * <code>ar.com.fdvs.dj.domain.AutoText</code> class <br>
     * <br>
     *
     * @param message
     *            The text to show
    ...
    public DynamicReportBuilder addConcatenatedReport(DynamicReport dynamicReport, LayoutManager layoutManager,
            String dataSourcePath, int dataSourceOrigin, int dataSourceType) throws DJBuilderException {
        Subreport subreport = new SubReportBuilder().setDataSource(dataSourceOrigin, dataSourceType, dataSourcePath)
                .setDynamicReport(dynamicReport, layoutManager).build();
    ...
    public DynamicReportBuilder addConcatenatedReport(DynamicReport dynamicReport, LayoutManager layoutManager,
            String dataSourcePath, int dataSourceOrigin, int dataSourceType, boolean startOnNewPage)
            throws DJBuilderException {
        Subreport subreport = new SubReportBuilder().setDataSource(dataSourceOrigin, dataSourceType, dataSourcePath)
                .setDynamicReport(dynamicReport, layoutManager).setStartInNewPage(startOnNewPage).build();

        concatenatedReports.add(subreport);
        return this;
    }

    public DynamicReportBuilder addConcatenatedReport(JasperReport jasperReport, String dataSourcePath,
            int dataSourceOrigin, int dataSourceType) throws DJBuilderException {
        Subreport subreport = new SubReportBuilder().setDataSource(dataSourceOrigin, dataSourceType, dataSourcePath)
                .setReport(jasperReport).build();
    ...
    public DynamicReportBuilder addConcatenatedReport(JasperReport jasperReport, String dataSourcePath,
            int dataSourceOrigin, int dataSourceType, boolean startOnNewPage) throws DJBuilderException {
        Subreport subreport = new SubReportBuilder().setDataSource(dataSourceOrigin, dataSourceType, dataSourcePath)
                .setReport(jasperReport).setStartInNewPage(startOnNewPage).build();
    ...
    public DynamicReportBuilder addFirstPageFooterImageBanner(String path, int width, int height,
    ...
    public DynamicReportBuilder addFirstPageImageBanner(String path, int width, int height,
    ...
    public DynamicReportBuilder addFirstPageImageBanner(String path, int width, int height,
            ImageBanner.Alignment alignment, ImageScaleMode scaleMode) {
        ImageBanner banner = new ImageBanner(path, width, height, alignment);
        banner.setScaleMode(scaleMode);
        options.getFirstPageImageBanners().put(alignment, banner);
        return this;
    ...
    public DynamicReportBuilder addFont(String fontName, java.awt.Font font) {
        report.getFontsMap().put(fontName, font);
        return this;
    }
    ...
    public DynamicReportBuilder addFooterCrosstab(DJCrosstab cross) {
        globalFooterCrosstabs.add(cross);
        return this;
    }

    @Deprecated
    public DynamicReportBuilder addFooterImageBanner(String path, int width, int height, byte align,
            ImageScaleMode scaleMode) {
        ImageBanner.Alignment alignment = ImageBanner.Alignment.fromValue(align);
        if (alignment == null) {
            throw new DJException("Invalid ImageBanner.Alignment");
    ...
    public DynamicReportBuilder addFooterImageBanner(String path, int width, int height,
            ImageBanner.Alignment alignment, ImageScaleMode scaleMode) {
        ImageBanner banner = new ImageBanner(path, width, height, alignment);
        banner.setScaleMode(scaleMode);
        options.getFooterImageBanners().put(alignment, banner);
    ...
    public DynamicReportBuilder addGlobalColumnVariable(String position, AbstractColumn column,
    ...
    /**
     * @param position
     *            DJConstants.FOOTER or DJConstants.HEADER
     * @param column
     *            column to operate with
     * @param valueExpression
     * @param style
     * @return
     */
    public DynamicReportBuilder addGlobalColumnVariable(String position, AbstractColumn column,
            CustomExpression valueExpression, Style style) {
        if (DJConstants.FOOTER.equals(position)) {
    ...
    public DynamicReportBuilder addGlobalColumnVariable(String position, AbstractColumn col, DJCalculation op,
            Style style, DJValueFormatter valueFormatter) {
        if (DJConstants.FOOTER.equals(position)) {
    ...
    private void addGlobalCrosstabs() {
        ...
        for (DJCrosstab djcross : globalHeaderCrosstabs) {
            DJGroup globalGroup = createDummyGroupForCrosstabs(
                    "crosstabHeaderGroup-" + globalHeaderCrosstabs.indexOf(djcross));
        ...
        for (DJCrosstab djcross : globalFooterCrosstabs) {
            DJGroup globalGroup = createDummyGroupForCrosstabs(
                    "crosstabFooterGroup-" + globalFooterCrosstabs.indexOf(djcross));
    ...
    public DynamicReportBuilder addHeaderCrosstab(DJCrosstab cross) {
        globalHeaderCrosstabs.add(cross);
        return this;
    }
    ...
    public DynamicReportBuilder addParameter(String name, String className) {
        report.addParameter(name, className);
        return this;
    }
    ...
    protected DynamicReportBuilder addSubreportInContainer(int groupNumber, Subreport subreport,
    ...
    /**
     * @param position
     *            {@link DJConstants#FOOTER} or {@link DJConstants#HEADER}
     * @param groupNumber
     * @param dynamicReport
     * @param layoutManager
     ...
     * @throws DJBuilderException
     */
    public DynamicReportBuilder addSubreportInGroup(String position, int groupNumber, DynamicReport dynamicReport,
            LayoutManager layoutManager, String dataSourcePath, int dataSourceOrigin, int dataSourceType,
            SubreportParameter[] params) throws DJBuilderException {
        if (DJConstants.FOOTER.equals(position)) {
            addSubreportInGroupFooter(groupNumber, dynamicReport, layoutManager, dataSourcePath, dataSourceOrigin,
                    dataSourceType, params);
        } else {
            addSubreportInGroupHeader(groupNumber, dynamicReport, layoutManager, dataSourcePath, dataSourceOrigin,
                    dataSourceType, params);
        }
        return this;
    }
    ...
    /**
     * @param position
     *            position {@link DJConstants#FOOTER} or {@link DJConstants#HEADER}
     * @param groupNumber
     * @param dynamicReport
     * @param layoutManager
     * @param dataSourcePath
    ...
    public DynamicReportBuilder addSubreportInGroup(String position, int groupNumber, DynamicReport dynamicReport,
            LayoutManager layoutManager, String dataSourcePath, int dataSourceOrigin, int dataSourceType,
            SubreportParameter[] params, boolean startInNewPage, boolean fitParent) throws DJBuilderException {

        if (DJConstants.FOOTER.equals(position)) {
            addSubreportInGroupFooter(groupNumber, dynamicReport, layoutManager, dataSourcePath, dataSourceOrigin,
                    dataSourceType, params, startInNewPage, fitParent);
        } else {
            addSubreportInGroupHeader(groupNumber, dynamicReport, layoutManager, dataSourcePath, dataSourceOrigin,
                    dataSourceType, params, startInNewPage, fitParent);
        }
    ...
    public DynamicReportBuilder addSubreportInGroupFooter(int groupNumber, DynamicReport dynamicReport,
            LayoutManager layoutManager, String dataSourcePath, int dataSourceOrigin, int dataSourceType)
            throws DJBuilderException {
        Subreport subreport = new SubReportBuilder().setDataSource(dataSourceOrigin, dataSourceType, dataSourcePath)
                .setDynamicReport(dynamicReport, layoutManager).build();
    ...
    public DynamicReportBuilder addSubreportInGroupFooter(int groupNumber, DynamicReport dynamicReport,
        ...
        srb.setDataSource(dataSourceOrigin, dataSourceType, dataSourcePath).setDynamicReport(dynamicReport,
                layoutManager);
    ...
    public DynamicReportBuilder addSubreportInGroupFooter(int groupNumber, DynamicReport dynamicReport,
            LayoutManager layoutManager, String dataSourcePath, int dataSourceOrigin, int dataSourceType,
            SubreportParameter[] params, boolean startInNewPage) throws DJBuilderException {
        SubReportBuilder srb = new SubReportBuilder();

        srb.setDataSource(dataSourceOrigin, dataSourceType, dataSourcePath).setStartInNewPage(startInNewPage)
    ...
    public DynamicReportBuilder addSubreportInGroupFooter(int groupNumber, DynamicReport dynamicReport,
        ...
        srb.setDataSource(dataSourceOrigin, dataSourceType, dataSourcePath).setStartInNewPage(startInNewPage)
                .setDynamicReport(dynamicReport, layoutManager).setFitToParentPrintableArea(fitParent);
    ...
    public DynamicReportBuilder addSubreportInGroupFooter(int groupNumber, String pathToSubreport,
            String dataSourcePath, int dataSourceOrigin, int dataSourceType) throws DJBuilderException {
    ...
    public DynamicReportBuilder addSubreportInGroupFooter(int groupNumber, String pathToSubreport,
            String dataSourcePath, int dataSourceOrigin, int dataSourceType, boolean startInNewPage)
            throws DJBuilderException {

        Subreport subreport = new SubReportBuilder().setDataSource(dataSourceOrigin, dataSourceType, dataSourcePath)
                .setPathToReport(pathToSubreport).setStartInNewPage(startInNewPage).build();
    ...
    public DynamicReportBuilder addSubreportInGroupHeader(int groupNumber, DynamicReport dynamicReport,
            LayoutManager layoutManager, String dataSourcePath, int dataSourceOrigin, int dataSourceType)
            throws DJBuilderException {
        Subreport subreport = new SubReportBuilder().setDataSource(dataSourceOrigin, dataSourceType, dataSourcePath)
                .setDynamicReport(dynamicReport, layoutManager).build();
    ...
    public DynamicReportBuilder addSubreportInGroupHeader(int groupNumber, String pathToSubreport,
            String dataSourcePath, int dataSourceOrigin, int dataSourceType) throws DJBuilderException {
    ...
    /**
     * Because the groups are not created until we call the "build()" method, all
     * the subreports that must go inside a group are handled here.
     */
    ...
    public DynamicReport build() {
        ...
        if (!globalVariablesGroup.getFooterVariables().isEmpty() || !globalVariablesGroup.getHeaderVariables().isEmpty()
                || !globalVariablesGroup.getVariables().isEmpty() || hasPercentageColumn()) {
    ...
    /**
     * Create dummy groups for each concatenated report, and in the footer of each
     * group adds the subreport.
     */
    ...
    public AbstractColumn getColumn(int idx) {
        return report.getColumns().get(idx);
    }
    ...
    public DJGroup getGroup(int idx) {
        return report.getColumnsGroups().get(idx);
    }
    ...
    public DynamicReportBuilder setAllowDetailSplit(boolean split) {
        report.setAllowDetailSplit(split);
        return this;
    }
     ...
     * @param colQuantity
     *            the number of cols how i will take
     * @param colspanTitle
     *            colspan title
     * @return a Dynamic Report Builder
     * @throws ColumnBuilderException
     *             When the index of the cols is out of bounds.
     */
    ...
    public DynamicReportBuilder setDefaultEncoding(String encoding) {
        report.setDefaultEncoding(encoding);
        return this;
    }
    ...
    public DynamicReportBuilder setGrandTotalLegend(String title) {
        globalVariablesGroup.getColumnToGroupBy().setTitle(title);
        return this;
    }

    public DynamicReportBuilder setGrandTotalLegendStyle(Style grandTotalStyle) {
        globalVariablesGroup.getColumnToGroupBy().setHeaderStyle(grandTotalStyle);
        globalVariablesGroup.getColumnToGroupBy().setStyle(grandTotalStyle);
        return this;
    }
    ...
    public DynamicReportBuilder setJasperDesignDecorator(JasperDesignDecorator jasperDesignDecorator) {
        report.setJasperDesignDecorator(jasperDesignDecorator);
        return this;
    }
    ...
    public DynamicReportBuilder setOddRowBackgroundStyle(Style oddRowBackgroundStyle) {
        options.setOddRowBackgroundStyle(oddRowBackgroundStyle);
        return this;
    }
    ...
    public DynamicReportBuilder setPrintBackgroundOnOddRows(boolean printBackgroundOnOddRows) {
        options.setPrintBackgroundOnOddRows(printBackgroundOnOddRows);
        return this;
    }
     ...
     * @param text
     * @param language
     *            use constants from {@link DJConstants}
     * @return
     */
    public DynamicReportBuilder setQuery(String text, String language) {
        report.setQuery(new DJQuery(text, language));
        return this;
    }
    ...
    /**
     * When false, no detail is shown. This is useful when using certain grouping
     * layout and header variables
     *
     * @param bool
     * @return A Dynamic Report Builder
     */
    public DynamicReportBuilder setShowDetailBand(boolean bool) {
        options.setShowDetailBand(bool);
        return this;
    }
     ...
     * @return
     */
    public DynamicReportBuilder setTemplateFile(String path, boolean importFields, boolean importVariables,
            boolean importParameters, boolean importDatasets) {
        report.setTemplateFileName(path);
    ...
    public DynamicReportBuilder setWhenNoData(String text, Style style) {
        report.setWhenNoDataStyle(style);
        report.setWhenNoDataText(text);
        report.setWhenNoDataType(DJConstants.WHEN_NO_DATA_TYPE_NO_DATA_SECTION);
        return this;
    }
     ...
     *            : if true, the column headers are shown
     * @return A Dynamic Report Builder
     */
    public DynamicReportBuilder setWhenNoData(String text, Style style, boolean showTitle, boolean showColumnHeader) {
        ...
        report.setWhenNoDataText(text);
        report.setWhenNoDataType(DJConstants.WHEN_NO_DATA_TYPE_NO_DATA_SECTION);
        report.setWhenNoDataShowColumnHeader(showColumnHeader);
        report.setWhenNoDataShowTitle(showTitle);
        return this;
    }
    ...
    public DynamicReportBuilder setWhenNoDataAllSectionNoDetail() {
        report.setWhenNoDataType(DJConstants.WHEN_NO_DATA_TYPE_ALL_SECTIONS_NO_DETAIL);
        return this;
    }
    ...
    public DynamicReportBuilder setWhenNoDataBlankPage() {
        report.setWhenNoDataType(DJConstants.WHEN_NO_DATA_TYPE_BLANK_PAGE);
        return this;
    }
    ...
    public DynamicReportBuilder setWhenNoDataNoPages() {
        report.setWhenNoDataType(DJConstants.WHEN_NO_DATA_TYPE_NO_PAGES);
        return this;
    }
    ...
    public DynamicReportBuilder setWhenNoDataType(byte whenNoDataType) {
        report.setWhenNoDataType(whenNoDataType);
        return this;
    }
    ...
    public DynamicReportBuilder setWhenResourceMissing(byte whenResourceMissing) {
        report.setWhenResourceMissing(whenResourceMissing);
        return this;
    }
    ...
    public DynamicReportBuilder setWhenResourceMissingReturnNull() {
        report.setWhenResourceMissing(DJConstants.WHEN_RESOURCE_MISSING_TYPE_NULL);
        return this;
    }

    public DynamicReportBuilder setWhenResourceMissingShowKey() {
        report.setWhenResourceMissing(DJConstants.WHEN_RESOURCE_MISSING_TYPE_KEY);
        return this;
    }

    public DynamicReportBuilder setWhenResourceMissingThrowException() {
        report.setWhenResourceMissing(DJConstants.WHEN_RESOURCE_MISSING_TYPE_ERROR);
        return this;
    }
}
