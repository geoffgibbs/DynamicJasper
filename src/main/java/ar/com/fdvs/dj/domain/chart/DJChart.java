...
public class DJChart extends DJBaseElement {
    ...
    /**
     * Returns the chart data operation (DJChart.CALCULATION_COUNT or
    ...
    public JRDesignChart transform(DynamicJasperDesign design, String name, JRDesignGroup group,
            JRDesignGroup parentGroup, Map vars, int width) {
