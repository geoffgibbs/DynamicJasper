...
public abstract class AbstractPlot extends DJBaseElement {
    ...
    /**
     * Gets the angle in degrees to rotate the data axis labels. The range is -360
    ...
    /**
     * Returns the plot orientation (PlotOrientation.HORIZONTAL or
    ...
    /**
     * Returns a list of all the defined series colors. Every entry in the list is
     * of type JRChartPlot.JRSeriesColor. If there are no defined series colors this
     * method will return an empty list, not null.
     *
