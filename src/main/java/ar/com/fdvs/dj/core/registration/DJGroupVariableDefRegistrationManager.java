...
public class DJGroupVariableDefRegistrationManager extends AbstractEntityRegistrationManager {
    ...
    public DJGroupVariableDefRegistrationManager(DynamicJasperDesign jd, DynamicReport dr, LayoutManager layoutManager,
            JRDesignGroup group) {
    ...
    protected void registerEntity(Entity entity) {
        try {
            ...
            columnsGroupVariable.getOperation();
    ...
    protected void registerField(ColumnProperty columnProperty) {
        ...
        log.debug("transforming column property for group variable: " + columnProperty.getProperty() + " ("
