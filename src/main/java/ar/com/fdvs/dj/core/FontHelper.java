...
public class FontHelper {
    ...
    /**
     * Calculates the minium height needed for the specified font and size. You must
     * also take in count if there is any padding, etc in your textfield. NOTE:
     * Under development. only works with SansSerif
     * 
     * @param font
     * @return
     */
