...
/**
 * An interface that represents a a Manager to make elements respect a desired
 * Layout.
 * 
 * @author msimone
 */
public interface LayoutManager {
     ...
     * An example of usage is the mapping between DJ objects and JR objects through
     * its name, like a DJGroup and a JRDesignGroup
     * 
     * @return
     */
