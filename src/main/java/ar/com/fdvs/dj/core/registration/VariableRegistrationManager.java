...
public class VariableRegistrationManager extends AbstractEntityRegistrationManager {
    ...
    protected Object transformEntity(Entity entity) throws JRException {
        ...
        JRDesignExpression expression = ExpressionUtils.createAndRegisterExpression(getDjd(), expressionParamName,
                var.getExpression());
        ...
        if (var.getInitialValueExpression() != null) {
            ...
            JRDesignExpression initialValueExpression = ExpressionUtils.createAndRegisterExpression(getDjd(),
                    initialValueExpressionParamName, var.getInitialValueExpression());
