...
public class CommonExpressionsHelper {
     ...
     * @param text
     */
    public static void add(int yOffset, DynamicJasperDesign design, AbstractLayoutManager lm, JRDesignBand band,
            AutoText text) {
    ...
    public static void addCreationDate(int yOffset, final DynamicJasperDesign design, final DynamicReport report,
            AbstractLayoutManager lm, JRDesignBand band, AutoText autoText) {
        ...
        dateTf.setExpression(AutoTextExpressionUtils.getDateExpression(KEY_autotext_created_on, "",
                report.getReportLocale(), autoText.getPattern()));
     ...
     * @param autoText
     */
    public static void addMessage(int yOffset, DynamicJasperDesign design, DynamicReport report,
            AbstractLayoutManager lm, JRDesignBand band, AutoText autoText) {
        int height = autoText.getHeight();
        ...
        textfield.setMarkup("styled"); // FIXME there are some other markups: see
     ...
     * @param autoText
     */
    public static void addPageX(int yOffset, DynamicJasperDesign design, DynamicReport report, AbstractLayoutManager lm,
            JRDesignBand band, AutoText autoText) {
        int height = autoText.getHeight();
        ...
        pageNumber.setExpression(AutoTextExpressionUtils.getPageNumberExpression("", "", autoText.getPageOffset(),
                autoText.isUseI18n()));
     ...
     * @param autoText
     */
    public static void addPageXofY(int yOffset, final DynamicJasperDesign design, final DynamicReport report,
            AbstractLayoutManager lm, JRDesignBand band, AutoText autoText) {
        ...
        pageNumber.setExpression(AutoTextExpressionUtils.getPageNumberExpression(KEY_autotext_page, KEY_autotext_of,
                autoText.getPageOffset(), true));
        pageNumber.setHeight(height);
        pageNumber.setWidth(autoText.getWidth());
        pageNumber.setY(yOffset);
        ...
        pageCounter.setExpression(
                AutoTextExpressionUtils.getPageNumberExpression(" ", "", autoText.getPageOffset(), false));
    ...
    public static void addPageXSlashY(int yOffset, final DynamicJasperDesign design, final DynamicReport report,
            AbstractLayoutManager lm, JRDesignBand band, AutoText autoText) {
