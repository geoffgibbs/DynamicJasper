...
public class DJCrosstabRegistrationManager extends AbstractEntityRegistrationManager {
    ...
    public DJCrosstabRegistrationManager(String type, DynamicJasperDesign jd, DynamicReport dr,
    ...
    protected void registerEntity(Entity entity) {
        ...
        if (crosstab.getMeasures() != null && !crosstab.getMeasures().isEmpty()) {
            DJCrosstabMeasureRegistrationManager measuresRm = new DJCrosstabMeasureRegistrationManager(type, getDjd(),
                    getDynamicReport(), getLayoutManager());
