...
public class DJCrosstabMeasureRegistrationManager extends AbstractEntityRegistrationManager {
    ...
    public DJCrosstabMeasureRegistrationManager(String type, DynamicJasperDesign jd, DynamicReport dr,
    ...
    protected void registerEntity(Entity entity) {
        ...
        if (measure.getConditionalStyles() != null && !measure.getConditionalStyles().isEmpty()) {
            ConditionalStylesRegistrationManager conditionalStylesRm = new ConditionalStylesRegistrationManager(
                    getDjd(), getDynamicReport(), measure.getProperty().getProperty() + "_" + type, getLayoutManager());
