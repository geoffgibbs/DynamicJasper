...
public class ColumnsGroupVariablesRegistrationManager extends AbstractEntityRegistrationManager {
    ...
    protected void registerEntity(Entity entity) {
        ...
        try {
            String name = getDjd().getName() + "_" + columnsGroupVariable.getColumnToApplyOperation()
            ...
            if (columnsGroupVariable.getPrintWhenExpression() != null) {
                registerCustomExpressionParameter(name + "_printWhenExpression",
                        columnsGroupVariable.getPrintWhenExpression());
            }
            if (columnsGroupVariable.getLabel() != null
                    && columnsGroupVariable.getLabel().getLabelExpression() != null) {
                registerCustomExpressionParameter(name + "_labelExpression",
                        columnsGroupVariable.getLabel().getLabelExpression());
            }
    ...
    /**
     * Registers the parameter for the value formatter for the given variable and
     * puts it's implementation in the parameters map.
     * 
     * @param djVariable
     * @param variableName
     */
