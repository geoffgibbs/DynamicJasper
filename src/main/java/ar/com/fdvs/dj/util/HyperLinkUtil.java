...
public class HyperLinkUtil {
     ...
     * @param name
     */
    public static void applyHyperLinkToElement(DynamicJasperDesign design, DJHyperLink djlink, JRDesignChart chart,
            String name) {
        ...
        if (djlink.getTooltip() != null) {
            JRDesignExpression tooltipExp = ExpressionUtils.createAndRegisterExpression(design, "tooltip_" + name,
                    djlink.getTooltip());
     ...
     * @param name
     */
    public static void applyHyperLinkToElement(DynamicJasperDesign design, DJHyperLink djlink, JRDesignImage image,
            String name) {
        ...
        if (djlink.getTooltip() != null) {
            ...
            String tooltipText = ExpressionUtils.createCustomExpressionInvocationText(djlink.getExpression(),
                    tooltipParameterName, false);
     ...
     * @param name
     */
    public static void applyHyperLinkToElement(DynamicJasperDesign design, DJHyperLink djlink,
            JRDesignTextField textField, String name) {
        // DJHyperLink djlink = column.getLink();
        StringExpression hce = djlink.getExpression();

        // String hceParameterName = "hyperlink_column_"
        // +column.getTextForExpression().replaceAll("[\\$\\{\\}]", "_");
        ...
        if (djlink.getTooltip() != null) {
            StringExpression sExp = djlink.getTooltip();
            // String tooltipParameterName = "hyperlink_tooltip_column_"
            // +column.getTextForExpression().replaceAll("[\\$\\{\\}]", "_");
