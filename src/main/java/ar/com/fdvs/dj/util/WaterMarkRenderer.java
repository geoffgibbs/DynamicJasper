...
/**
 * Created by dj on 01/12/15. Took from:
 * http://stackoverflow.com/questions/11665663/watermark-across-the-page-in-jasperreports
 */
@SuppressWarnings("deprecation")
public class WaterMarkRenderer extends JRAbstractRenderer {
    public static BufferedImage rotateText(String text, Font font, int width, int height, int textAngle,
            Color textColor) {
        if (text == null) {
        ...
        double caLinesCountD = completeWidth / width;
        int caLinesCount;
