...
/**
 * @author Alejandro Gomez (alejandro.gomez@fdvsolutions.com) Date: Aug 15, 2007
 *         Time: 1:47:28 PM
 */
public class DJJRJdtCompiler extends JRJdtCompiler {
    ...
    protected Map<String, String> getJdtSettings() {
        ...
        if (encoding != null) {
            // settings.put(CompilerOptions.OPTION_Encoding, encoding); //this needs and
            // import from here: import
