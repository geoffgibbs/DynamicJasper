...
public class StylesReport2Test extends BaseDjReportTest {
    ...
    public DynamicReport buildReport() throws Exception {
        ...
        drb.setTitle("November " + getYear() + " sales report") // defines the title of the report
                ...
                .setTitleStyle(titleStyle).setTitleHeight(30).setDefaultStyles(null, null, null, detailStyle)
                .setSubtitleHeight(20).setDetailHeight(15)
        ...
        AbstractColumn columnCode = ColumnBuilder.getNew().setColumnProperty("id", Long.class.getName()).setTitle("ID")
                .setWidth(new Integer(40)).setStyle(numberStyle).setHeaderStyle(headerStyle).build();
