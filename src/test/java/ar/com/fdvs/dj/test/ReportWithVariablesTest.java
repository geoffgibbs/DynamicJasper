...
public class ReportWithVariablesTest extends BaseDjReportTest {
    ...
    public DynamicReport buildReport() throws Exception {
        ...
        drb.addColumn("State", "state", String.class.getName(), 30)
                ...
                .addColumn("Balance",
                        new DJSimpleExpression(DJSimpleExpression.TYPE_VARIABLE, "acum", Float.class.getName()), 80,
                        false, null, style)
                .addVariable("acum", DJCalculation.SUM,
                        new DJSimpleExpression(DJSimpleExpression.TYPE_FIELD, "amount", Float.class.getName()))
                .addGroups(2).setTitle("November " + getYear() + " sales report")
        ...
        // .setCustomExpression(new DJSimpleExpression(DJSimpleExpression.TYPE_VARIABLE,
        // "acum", Float.class.getName())).setWidth(80).setStyle(style).build();
        //
