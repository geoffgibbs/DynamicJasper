...
/**
 * This test demonstrates how to add a variable into a group and use it later
 * inside an custom expression.
 */
public class GroupsVariableTest1 extends BaseDjReportTest {
    ...
    public DynamicReport buildReport() throws Exception {
        ...
        DJGroup g1 = gb1.setCriteriaColumn((PropertyColumn) columnState).setGroupLayout(GroupLayout.VALUE_IN_HEADER)
                .setFooterVariablesHeight(20).setFooterHeight(50, true).setHeaderVariablesHeight(35)
