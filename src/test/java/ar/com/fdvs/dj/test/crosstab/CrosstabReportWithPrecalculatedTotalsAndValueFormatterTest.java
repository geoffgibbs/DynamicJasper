...
public class CrosstabReportWithPrecalculatedTotalsAndValueFormatterTest extends BaseDjReportTest {
    ...
    public static void main(String[] args) throws Exception {
        CrosstabReportWithPrecalculatedTotalsAndValueFormatterTest test =
                new CrosstabReportWithPrecalculatedTotalsAndValueFormatterTest();
        test.testReport();
    ...
    public DynamicReport buildReport() throws Exception {
        ...
        DJCrosstab djcross = new CrosstabBuilder().setHeight(200).setWidth(500).setHeaderStyle(mainHeaderStyle)
                ...
                // measureStyle)
                .addMeasure("quantity", Long.class.getName(), DJCalculation.SUM, "Time", measureStyle2,
