...
public class GroupLabelTest5 extends BaseDjReportTest {
    ...
    public DynamicReport buildReport() throws Exception {
        ...
        Style glabelStyle = new StyleBuilder(false).setFont(Font.ARIAL_SMALL).setHorizontalAlign(HorizontalAlign.RIGHT)
                .setBorderTop(Border.THIN()).setStretchWithOverflow(false).build();
        ...
        DJGroupLabel glabel3 = new DJGroupLabel(new StringExpression() {
            @Override
            public Object evaluate(Map fields, Map variables, Map parameters) {
                return "group: \"" + variables.get("state_name") + "\", count: "
                        + ExpressionHelper.getGroupCount("group_state", variables) + ", total amount: "
                        + variables.get("sum_amount");
            }
        ...
        DJGroup g1 = gb1.setCriteriaColumn((PropertyColumn) columnState)
                ...
                // .addFooterVariable(columnAmount,DJCalculation.SUM,headerVariables, null,
                // glabel1) // tell the group place a variable footer of the column
                // "columnAmount" with the SUM of allvalues of the columnAmount in this group.
                .addFooterVariable(columnaQuantity, DJCalculation.SUM, headerVariables, null, glabel2) // idem for the
                                                                                                       // columnaQuantity
                                                                                                       // column
                ...
                .setFooterLabel(glabel3).setFooterVariablesHeight(30).build();
