...
public class ImageExpressionColumnReportTest extends BaseDjReportTest {
    ...
    public DynamicReport buildReport() throws Exception {
        ...
        Style style = new StyleBuilder(false).setHorizontalAlign(HorizontalAlign.CENTER)
                .setStretching(Stretching.RELATIVE_TO_TALLEST_OBJECT).setBorderColor(Color.BLACK)
                .setBorder(Border.THIN()).build();
        /*
        ...
        drb.addColumn("State", "state", String.class.getName(), 30)
                ...
                .addColumn("Amount", "amount", Float.class.getName(), 70, true).addGroups(2).setDetailHeight(17)
