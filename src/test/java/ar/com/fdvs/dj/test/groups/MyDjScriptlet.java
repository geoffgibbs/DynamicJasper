...
/**
 * It is very important to extend {@link DJDefaultScriptlet} because it is
 * needed for the normal operation of the Report.
 * 
 * @author mamana
 *
 */
public class MyDjScriptlet extends DJDefaultScriptlet {
    ...
    public void afterGroupInit(String groupName) throws JRScriptletException {
        ...
        /*
         * Recover JasperReport variable (the holder for the calculated value) The
         * naming convention used in DJ is:
         * <ReportName>_variable-<[header|footer]>_<grouped column property>_<column
         * with the variable> As an example: XXXX_variable-header_state_quantity stands
         * for: a header variable placed in the group for the column "state" which
         * calculates in the column "quantity" In the example, XXXX is the report name
         * which is obtained from current JasperReport object (from the parameters map)
         */
