...
public class GroupsReportTestG2T1 extends BaseDjReportTest {
    ...
    public DynamicReport buildReport() throws Exception {
        ...
        drb.setTitleStyle(titleStyle).setTitle("November " + getYear() + " sales report") // defines the title of the
                ...
                .setGrandTotalLegendStyle(g2VariablesStyle).setDefaultStyles(titleStyle, null, headerStyle, detailStyle)
        ...
        AbstractColumn columnBranch = ColumnBuilder.getNew().setColumnProperty("branch", String.class.getName())
                .setTitle("Branch").setWidth(new Integer(85)).setStyle(col2Style).setHeaderStyle(col2Style).build();
