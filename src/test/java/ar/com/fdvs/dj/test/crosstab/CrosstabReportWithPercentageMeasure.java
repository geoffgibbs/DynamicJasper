...
public class CrosstabReportWithPercentageMeasure extends BaseDjReportTest {
    ...
    public DynamicReport buildReport() throws Exception {
        ...
        DJCrosstab djcross = new CrosstabBuilder().setHeight(400).setWidth(700).setHeaderStyle(mainHeaderStyle)
                .useMainReportDatasource(false).setUseFullWidth(true).setColorScheme(colorScheme)
                ...
                .addMeasure("amount", Float.class.getName(), DJCalculation.SUM, "%", measureStyle2, valueFormatter,
                        true)
                .setRowStyles(rowHeaderStyle, totalStyle, totalHeaderStyle)
                .setColumnStyles(colHeaderStyle, totalStyle, totalHeaderStyle).setCellDimension(34, 70)
                .setColumnHeaderHeight(30).setRowHeaderWidth(80).setDatasource("sr",
    ...
    private void initStyles() {
        ...
        totalHeaderStyle = new StyleBuilder(false).setHorizontalAlign(HorizontalAlign.CENTER)
                ...
                .setTransparency(Transparency.OPAQUE).setTextColor(Color.BLUE).setBackgroundColor(pastelR).build();
        rowHeaderStyle = new StyleBuilder(false).setHorizontalAlign(HorizontalAlign.LEFT)
                ...
                .setBackgroundColor(new Color(240, 248, 255)).setBackgroundColor(pastelYellow).build();
        colHeaderStyle = new StyleBuilder(false).setHorizontalAlign(HorizontalAlign.LEFT)
                .setVerticalAlign(VerticalAlign.TOP).setFont(Font.ARIAL_MEDIUM_BOLD)
                .setBackgroundColor(new Color(255, 240, 248)).setBackgroundColor(pastelGreen).build();
