...
public class SubreportWithParametersReportTest extends BaseDjReportTest {
    ...
    public DynamicReport buildReport() throws Exception {
        ...
        drb.addColumn("City", "city", String.class.getName(), 50, valueStyle, columnTitleStyle)
                ...
                .setGroupLayout(2, GroupLayout.EMPTY).setTitle("Customers consumptions").setPrintColumnNames(false)
        ...
        SubreportParameter[] subreportParameters = new SubreportParameter[] { new SubreportParameter("custId", "id",
                Integer.class.getName(), DJConstants.SUBREPORT_PARAM_ORIGIN_FIELD) };
        drb.addSubreportInGroupFooter(2, drLevel2, new ClassicLayoutManager(), null,
                DJConstants.DATA_SOURCE_ORIGIN_USE_REPORT_CONNECTION, DJConstants.DATA_SOURCE_TYPE_SQL_CONNECTION,
                subreportParameters);
    ...
    private DynamicReport createLevel2Subreport() throws Exception {
        ...
        DynamicReport dr = rb.addColumn("Invoice", "invoiceid", Long.class.getName(), 40)
                ...
                .addColumn("Total", "itemtotal", Float.class.getName(), 80).addGroups(1)
                ...
                .setQuery(
                        "SELECT a.quantity, a.cost, b.name, b.price, a.invoiceid,  a.cost * b.price itemtotal, c.customerid "
                                + " FROM item a, product b, invoice c"
                                + " where a.productid = b.id and a.invoiceId = c.id and c.customerid = $P{custId} order by a.invoiceid, item",
                        DJConstants.QUERY_LANGUAGE_SQL)
                .setUseFullPageWidth(false).setDefaultStyles(null, null, header, null)
                .addParameter("custId", Integer.class.getName()).setWhenNoData("No invoices for this customer", null)
                .setMargins(0, 0, 30, 30).build();
        return dr;
    }
