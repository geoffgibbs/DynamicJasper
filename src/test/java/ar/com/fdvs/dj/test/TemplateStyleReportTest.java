...
public class TemplateStyleReportTest extends BaseDjReportTest {
    ...
    public DynamicReport buildReport() throws Exception {
        ...
        /*
         * "titleStyle" exists in the template .jrxml file The title should be seen in a
         * big font size, violet foreground and light green background
         */
        ...
        drb.setTitle("November " + getYear() + " sales report")
                ...
                .setDefaultStyles(titleStyle, subtitleStyle, headerStyle, null).addStyle(subtitleStyleParent); // register
                                                                                                               // the
                                                                                                               // parent
                                                                                                               // style
