...
public class SubReportWithTemplateTest extends BaseDjReportTest {
    ...
    public DynamicReport buildReport() throws Exception {
        ...
        drb.addColumn("State", "state", String.class.getName(), 30)
                ...
                .addColumn("Amount", "amount", Float.class.getName(), 70, true).addGroups(2).setMargins(5, 5, 40, 20)
        ...
        drb.addSubreportInGroupHeader(2, drHeaderSubreport, new ClassicLayoutManager(), "statistics",
        ...
        drb.addSubreportInGroupFooter(2, drFooterSubreport, new ClassicLayoutManager(), "statistics",
                DJConstants.DATA_SOURCE_ORIGIN_FIELD, DJConstants.DATA_SOURCE_TYPE_COLLECTION);
