...
public class CustomExpressionReportTest2 extends BaseDjReportTest {
    ...
    public DynamicReport buildReport() throws Exception {
        ...
        AbstractColumn columnaCustomExpression = ColumnBuilder.getNew().setCustomExpression(getCustomExpression())
                // .setColumnProperty("item", String.class.getName())
                .setTitle("CustomExp").setWidth(new Integer(200)).setStyle(detailStyle).setHeaderStyle(headerStyle)
                .build();

        AbstractColumn columnaNumberCustomExpression = ColumnBuilder.getNew()
                .setCustomExpression(getNumberCustomExpression()).setTitle("Item Number").setWidth(new Integer(40))
                .setStyle(detailStyle).setHeaderStyle(headerStyle).build();
