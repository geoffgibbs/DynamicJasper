    ...
    public DynamicReport buildReport() throws Exception {
        ...
        DJGroup g1 = gb1.setCriteriaColumn((PropertyColumn) columnState)
                ...
                .addFooterVariable(columnaQuantity, DJCalculation.SUM, headerVariables) // idem for the columnaQuantity
                                                                                        // column
                .setGroupLayout(GroupLayout.DEFAULT_WITH_HEADER) // tells the group how to be shown, there are
                                                                 // manyposibilities, see the GroupLayout for more.
                .setReprintHeaderOnEachPage(true).build();

        GroupBuilder gb2 = new GroupBuilder(); // Create another group (using another column as criteria)
        Style styleg2HeaderDefault = new StyleBuilder(false).setName("g2Header").setBackgroundColor(Color.YELLOW)
                .setTransparent(false).setFont(new Font(7, Font._FONT_ARIAL, false)).setBorderBottom(Border.THIN())
        ...
        DJGroup g2 = gb2.setCriteriaColumn((PropertyColumn) columnBranch) // and we add the same operations for the
                ...
                .addFooterVariable(columnaQuantity, DJCalculation.SUM).addColumnHeaderStyle(columnAmount, styleg2Header)
                .setDefaultColumnHeaderStyle(styleg2HeaderDefault).setGroupLayout(GroupLayout.DEFAULT_WITH_HEADER)
                .setHeaderHeight(10).build();
