...
public class ImageBannerFooterReportTest extends BaseDjReportTest {
    ...
    public DynamicReport buildReport() throws Exception {
        ...
        drb.setTitleStyle(titleStyle).setTitle("November " + getYear() + " sales report") // defines the title of the
                ...
                // .addFirstPageFooterImageBanner(System.getProperty("user.dir") +
                // "/target/test-classes/images/logo_fdv_solutions_60.png", new Integer(197),
                // new Integer(60), ImageBanner.Alignment.Right)
                // .addFirstPageFooterImageBanner(System.getProperty("user.dir") +
                // "/target/test-classes/images/dynamicJasper_60.jpg", new Integer(300), new
                // Integer(60), ImageBanner.Alignment.Right)
                .addFooterImageBanner(
                        System.getProperty("user.dir") + "/target/test-classes/images/logo_fdv_solutions_60.png", 100,
                        25, ImageBanner.Alignment.Left, ImageScaleMode.FILL)
                .addFooterImageBanner(
                        System.getProperty("user.dir") + "/target/test-classes/images/dynamicJasper_60.jpg", 150, 45,
                        ImageBanner.Alignment.Right, ImageScaleMode.FILL);

        AbstractColumn columnState = ColumnBuilder.getNew().setColumnProperty("state", String.class.getName())
                .setTitle("State").setWidth(new Integer(85)).setStyle(titleStyle).setHeaderStyle(headerStyle).build();
