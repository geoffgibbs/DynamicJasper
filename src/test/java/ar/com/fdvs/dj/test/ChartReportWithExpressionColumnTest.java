...
public class ChartReportWithExpressionColumnTest extends BaseDjReportTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // test.getLayoutManager(),test.params));
    }
    ...
    public DynamicReport buildReport() throws Exception {
        ...
        AbstractColumn columnAmount = ColumnBuilder.getNew().setCustomExpression(new CustomExpression() {
            @Override
        ...
        DJGroup g1 = gb1.setCriteriaColumn((PropertyColumn) columnState)
                .addFooterVariable(columnAmount, DJCalculation.SUM) // tell the group place a variable footer of the
                                                                    // column "columnAmount" with the SUM of allvalues
                                                                    // of the columnAmount in this group.
        ...
        DJChart chart = cb.setType(DJChart.BAR_CHART).setOperation(DJChart.CALCULATION_SUM).setColumnsGroup(g1)
