...
public class VariableValueFormatterReportTest extends BaseDjReportTest {
    ...
    public DynamicReport buildReport() throws Exception {
        ...
        AbstractColumn columnaCustomExpression = ColumnBuilder.getNew().setCustomExpression(getCustomExpression())
                .setCustomExpressionForCalculation(getCustomExpression2()).setTitle("Duration")
                .setWidth(new Integer(90)).setStyle(amountStyle).setHeaderStyle(headerStyle).build();
        ...
        DJGroup group = new GroupBuilder().setCriteriaColumn((PropertyColumn) columnState)
                .addFooterVariable(columnaCustomExpression, DJCalculation.SUM, null, getValueFormatter()).build();
