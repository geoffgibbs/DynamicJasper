...
public class CrosstabReportTest8 extends BaseDjReportTest {
    ...
    public DynamicReport buildReport() throws Exception {
        ...
        DJCrosstab djcross = new CrosstabBuilder().setHeight(200).setWidth(500).setHeaderStyle(mainHeaderStyle)
                ...
                .addMeasure("id", Long.class.getName(), DJCalculation.SUM, "Id", measureStyle).addMeasure(measure)
                .setRowStyles(colAndRowHeaderStyle, null, totalHeaderStyle)
                .setColumnStyles(colAndRowHeaderStyle, null, totalHeaderStyle).setCellDimension(34, 60)
    ...
    private ArrayList createConditionalStyles(Style baseStyle)
        ...
        StatusLightCondition status0 = new StatusLightCondition(0d, 3000d); // TODO ENHANCEMENT make it come from a
                                                                            // parameter??? $P{...}
