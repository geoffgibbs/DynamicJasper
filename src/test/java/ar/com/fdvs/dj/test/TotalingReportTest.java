...
public class TotalingReportTest extends BaseDjReportTest {
    ...
    public DynamicReport buildReport() throws Exception {
        ...
        Style headerStyle1 = new StyleBuilder(false).setFont(Font.ARIAL_BIG).setBorderBottom(Border.THIN())
                .setPaddingTop(15).build();
        ...
        drb.addColumn("State", "state", String.class.getName(), 70, headerStyle1, headerStyle1)
                ...
                .addColumn("Amount", "amount", Float.class.getName(), 70).addGroups(2)
                .setTitle("November " + getYear() + " sales report")
                .setSubtitle("This report was generated at " + new Date()).setPrintBackgroundOnOddRows(false)
                .setPrintColumnNames(false).setShowDetailBand(false).setUseFullPageWidth(true);

        Style hstyle1 = new StyleBuilder(false).setHorizontalAlign(HorizontalAlign.RIGHT).setBorderBottom(Border.THIN())
                .build();
        Style hstyle2 = new StyleBuilder(false).setHorizontalAlign(HorizontalAlign.RIGHT).setFont(Font.ARIAL_SMALL)
                .build();
