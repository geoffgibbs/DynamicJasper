...
public class HQLReportTest extends BaseDjReportTest {
    ...
    public DynamicReport buildReport() throws Exception {
        ...
        drb.addColumn("City", "city", String.class.getName(), 50, groupStyle)
                ...
                .addColumn("Street", "street", String.class.getName(), 50).addGroups(1, GroupLayout.VALUE_IN_HEADER)
                .setTitle("Customers").setSubtitle("Order by city and last name")
