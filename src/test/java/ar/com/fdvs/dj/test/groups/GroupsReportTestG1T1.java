...
public class GroupsReportTestG1T1 extends BaseDjReportTest {
    ...
    public DynamicReport buildReport() throws Exception {
        ...
        // drb.addGlobalHeaderVariable(columnaQuantity,
        // ColumnsGroupVariableOperation.SUM,headerVariables);
        // drb.addGlobalFooterVariable(columnAmount,
        // ColumnsGroupVariableOperation.SUM,headerVariables);
        // drb.addGlobalFooterVariable(columnaQuantity,
        // ColumnsGroupVariableOperation.SUM,headerVariables);
        ...
        DJGroup g1 = gb1.setCriteriaColumn((PropertyColumn) columnState)
                .addHeaderVariable(columnAmount, DJCalculation.SUM, headerVariables) // tell the group place a variable
                                                                                     // footer of the column
                                                                                     // "columnAmount" with the SUM
                                                                                     // of allvalues of the
                                                                                     // columnAmount in this group.
                .addHeaderVariable(columnaQuantity, DJCalculation.SUM, headerVariables) // idem for the columnaQuantity
                                                                                        // column
