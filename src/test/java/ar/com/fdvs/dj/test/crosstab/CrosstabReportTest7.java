...
public class CrosstabReportTest7 extends BaseDjReportTest {
    ...
    public DynamicReport buildReport() throws Exception {
        ...
        DJCrosstab djcross = new CrosstabBuilder().setHeight(400).setWidth(500).setHeaderStyle(mainHeaderStyle)
                .useMainReportDatasource(true).setUseFullWidth(true).setColorScheme(colorScheme).setAutomaticTitle(true)
                .setCellBorder(Border.PEN_1_POINT()).addRow("State", "state", String.class.getName(), true)
