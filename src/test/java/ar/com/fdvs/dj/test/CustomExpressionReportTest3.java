...
public class CustomExpressionReportTest3 extends BaseDjReportTest {
    ...
    public DynamicReport buildReport() throws Exception {
        ...
        // ColumnBuilder.getNew().setColumnProperty("branch", String.class.getName())
        // .setTitle("Branch").setWidth(new Integer(85))
        // .setStyle(detailStyle).setHeaderStyle(headerStyle).build();

        // AbstractColumn columnaProductLine =
        // ColumnBuilder.getNew().setColumnProperty("productLine",
        ...
        AbstractColumn columnaCustomExpression = ColumnBuilder.getNew().setCustomExpression(getRatioExpression())
                // .setCustomExpressionForCalculation(getCustomExpression3())
                // .setColumnProperty("item", String.class.getName())
                .setTitle("CustomExp").setWidth(new Integer(90)).setPattern("#,##0.0").setStyle(detailStyle)
                .setHeaderStyle(headerStyle).build();
        ...
        DJGroup g1 = gb1.setCriteriaColumn((PropertyColumn) columnState).addFooterVariable(var)
    ...
    /*
     * private BooleanExpression getPrintWhenExpression() { return new
     * BooleanExpression() {
     * 
     * public Object evaluate(Map fields, Map variables, Map parameters) { Long
     * quantity = (Long) variables.get("quantity_sum_g1"); return new
     * Boolean(quantity.doubleValue() > 20000); }
     * 
     * }; }
     */
