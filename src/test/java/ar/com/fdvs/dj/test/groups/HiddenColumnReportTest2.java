...
public class HiddenColumnReportTest2 extends BaseDjReportTest {
    ...
    public DynamicReport buildReport() throws Exception {
        ...
        drb.setTitleStyle(titleStyle).setTitle("November " + getYear() + " sales report") // defines the title of the
                ...
                // .addHeaderHeight(100)
                .setAllowDetailSplit(false).setOddRowBackgroundStyle(oddRowStyle);

        AbstractColumn columnState = ColumnBuilder.getNew().setColumnProperty("state", String.class.getName())
                .setTitle("State:").setWidth(80).setStyle(detailStyle).setHeaderStyle(headerStyle).build();
        ...
        DJGroup g2 = gb2.setCriteriaColumn((PropertyColumn) columnBranch) // and we add the same operations for the
                ...
                .addFooterVariable(columnaQuantity, DJCalculation.SUM).setGroupLayout(GroupLayout.EMPTY) // tells the
                                                                                                         // group how
                                                                                                         // to be
                                                                                                         // shown,
                                                                                                         // there are
