...
public class PercentageColumnReportTest extends BaseDjReportTest {
    ...
    public DynamicReport buildReport() throws Exception {
        ...
        drb.setTitle("November " + getYear() + " sales report") // defines the title of the report
                ...
                .setTitleStyle(titleStyle).setTitleHeight(30).setSubtitleHeight(20).setDetailHeight(16)
        ...
        AbstractColumn columnPercentageAmount = ColumnBuilder.getNew()
                .setPercentageColumn((PropertyColumn) columnAmount).setTitle("Amount [%]").setWidth(new Integer(90))
                .setStyle(amountStyle).setHeaderStyle(headerStyle).build();
        ...
        DJGroup g1 = gb1.setCriteriaColumn((PropertyColumn) columnState)
                .addFooterVariable(columnAmount, DJCalculation.SUM).setGroupLayout(GroupLayout.DEFAULT) // tells the
                                                                                                        // group how to
                                                                                                        // be shown,
                                                                                                        // there are
                                                                                                        // manyposibilities,
        ...
        DJGroup g2 = gb2.setCriteriaColumn((PropertyColumn) columnBranch)
                ...
                .addFooterVariable(columnPercentageAmount, DJCalculation.SUM).setGroupLayout(GroupLayout.DEFAULT) // tells
                                                                                                                  // the
                                                                                                                  // group
                                                                                                                  // how
                                                                                                                  // to
