...
public class HiddenColumnReportTest extends BaseDjReportTest {
    ...
    public DynamicReport buildReport() throws Exception {
        ...
        AbstractColumn columnState = ColumnBuilder.getNew().setColumnProperty("state", String.class.getName())
                .setTitle("State").setWidth(new Integer(85)).setStyle(specialDetailStyle).setHeaderStyle(headerStyle)
                .build();

        AbstractColumn columnBranch = ColumnBuilder.getNew().setColumnProperty("branch", String.class.getName())
                .setTitle("Branch").setWidth(new Integer(85)).setStyle(specialDetailStyle2).setHeaderStyle(headerStyle)
                .build();
        ...
        DJGroup g2 = gb2.setCriteriaColumn((PropertyColumn) columnBranch) // and we add the same operations for the
                ...
                .addFooterVariable(columnaQuantity, DJCalculation.SUM).setGroupLayout(GroupLayout.VALUE_IN_HEADER) // tells
                                                                                                                   // the
                                                                                                                   // group
                                                                                                                   // how
                                                                                                                   // to
