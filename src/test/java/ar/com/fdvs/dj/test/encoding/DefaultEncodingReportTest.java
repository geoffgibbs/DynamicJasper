...
public class DefaultEncodingReportTest extends BaseDjReportTest {
    ...
    public static Collection getDummyCollection() {
        ...
        col.add(new Product(1L, "book", "ąćęłńóśźż",
                "abcdefghaijkslmnopqĄĆĘŁŃÓŚŹŻĄĆĘŁŃÓŚŹŻĄĆĘŁŃÓŚŹŻĄĆĘŁŃÓŚŹŻĄĆĘŁŃÓŚŹŻĄĆĘŁ", "Main Street", new Long("2500"),
                new Float("5")));
    ...
    public DynamicReport buildReport() throws Exception {
        ...
        drb.addColumn("State", "state", String.class.getName(), 30)
                ...
                .setSubtitle("ĄĆ\tĘ\tŁ\tŃ\tÓ\tŚ\tŹ\tŻ\tą\tć\tę\tł\tń\tó\tś\tź\tż").setPrintBackgroundOnOddRows(true)
                .setDefaultStyles(titleStyle, subtitleStyle, headerStyle, detailStyle).setDefaultEncoding(encoding)
