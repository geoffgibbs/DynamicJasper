...
public class BarcodeColumnReportTest2 extends BaseDjReportTest {
    ...
    public DynamicReport buildReport() throws Exception {
        ...
        Style defStyle = new StyleBuilder(true).setBorderBottom(Border.THIN())
                .setStretching(Stretching.RELATIVE_TO_TALLEST_OBJECT).setPaddingBottom(3).setPaddingTop(3).build();
        /*
        ...
        drb.addColumn("State", "state", String.class.getName(), 20, defStyle)
                ...
                .addBarcodeColumn("Bar-Code", "amount", Long.class.getName(), BarcodeTypes.USD3, true, false, null, 100,
                        true, ImageScaleMode.FILL, defStyle)
                .addGroups(1).setDetailHeight(30).addField("productLine", String.class.getName())
                .setTitle("November " + getYear() + " sales report")
                .setSubtitle("This report was generated at " + new Date())
                .setDefaultStyles(title, subtitle, columnHeader, defStyle).setUseFullPageWidth(true);
    ...
    protected JRDataSource getDataSource() {
        ...
        dummyCollection.add(new Product(new Long("1"), "book", "Harry Potter 7", "Florida",
