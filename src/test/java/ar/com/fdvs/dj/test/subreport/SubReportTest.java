...
public class SubReportTest extends BaseDjReportTest {
    ...
    public DynamicReport buildReport() throws Exception {
        ...
        drb.addSubreportInGroupHeader(2, drHeaderSubreport, new ClassicLayoutManager(), "emptyStatistics",
        ...
        drb.addSubreportInGroupHeader(2, drFooterSubreport, new ClassicLayoutManager(), "statistics",
                DJConstants.DATA_SOURCE_ORIGIN_FIELD, DJConstants.DATA_SOURCE_TYPE_COLLECTION);
    ...
    private DynamicReport createFooterSubreport() throws Exception {
        ...
        DynamicReport dr = rb.addColumn("Area", "name", String.class.getName(), 100)
                ...
                .setUseFullPageWidth(true).setTitle("Footer Subreport for this group").build();
        return dr;
    }
    ...
    private DynamicReport createHeaderSubreport() throws Exception {
        ...
        DynamicReport dr = rb.addColumn("Date", "date", Date.class.getName(), 100)
                ...
                .setUseFullPageWidth(true).setWhenNoDataNoPages().setTitle("Header Subreport for this group").build();
        return dr;
    }
