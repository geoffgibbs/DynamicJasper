...
public class BarChartBuilderExpressionColumnTest extends BaseDjReportTest {
    ...
    protected void setUp() throws Exception {
        ...
        DJGroup g1 = gb1.setCriteriaColumn((PropertyColumn) columnState)
                ...
                .addVariable("group_state_name", columnState, DJCalculation.FIRST).setGroupLayout(GroupLayout.DEFAULT)
                .build();
        /*
        ...
        DJChart djChart = new DJBarChartBuilder()
                // chart
                .setX(20).setY(10).setWidth(500).setHeight(250).setCentered(false).setBackColor(Color.LIGHT_GRAY)
                ...
                // dataset
                .setCategory((PropertyColumn) columnBranch).addSerie(columnaQuantity, "quant.").addSerie(columnAmount)
                // plot
                .setShowTickMarks(true).setShowTickLabels(true).setShowLabels(false)
                .setCategoryAxisFormat(categoryAxisFormat).setValueAxisFormat(valueAxisFormat).build();
    ...
    public void testChart() {
        ...
        assertEquals(LineStyleEnum.getByValue(new Byte(DJChartOptions.LINE_STYLE_DOTTED)),
                chart.getLineBox().getPen().getLineStyleValue());
