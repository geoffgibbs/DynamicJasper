...
public class CrosstabReportWithMMValueFormatterTest extends BaseDjReportTest {
    ...
    public DynamicReport buildReport() throws Exception {
        ...
        DJCrosstab djcross = new CrosstabBuilder().setHeight(200).setWidth(500).setHeaderStyle(mainHeaderStyle)
                ...
                .addMeasure("id", Long.class.getName(), DJCalculation.SUM, "Id", measureStyle).addMeasure("quantity",
                        Long.class.getName(), DJCalculation.FIRST, "Time", measureStyle2, new DjBaseMMValueFormatter() {
