...
public class CrosstabForExcelReportTest extends BaseDjReportTest {
    ...
    public DynamicReport buildReport() throws Exception {
        ...
        drb.setTitle("November " + getYear() + " sales report")
                ...
                .setPrintColumnNames(false).setUseFullPageWidth(true).setIgnorePagination(true)
                .setPageSizeAndOrientation(new Page(2000, 3000, true)).setDefaultStyles(titleStyle, null, null, null);
        ...
        DJCrosstab djcross = new CrosstabBuilder().setHeight(200).setWidth(500).setHeaderStyle(mainHeaderStyle)
                ...
                .setCellBorder(Border.THIN()).addRow("Product Line", "productLine", String.class.getName(), false)
                ...
                .setColumnStyles(colAndRowHeaderStyle, totalStyle, totalHeaderStyle).setCellDimension(34, 60)
