...
public class TimeSeriesChartBuilderTest extends BaseDjReportTest {
    ...
    protected void setUp() throws Exception {
        ...
        AbstractColumn columnDate = ColumnBuilder.getNew().setColumnProperty("date", Date.class.getName())
                .setTitle("Date").setWidth(new Integer(85)).build();
        ...
        DJChart djChart = new DJTimeSeriesChartBuilder()
                ...
                .setShowLegend(true).setPosition(DJChartOptions.POSITION_FOOTER).setTitle(new StringExpression() {
                    ...
                    public Object evaluate(Map fields, Map variables, Map parameters) {
                        return "From " + format.format((Date) variables.get("min_date")) + " to "
                                + format.format((Date) variables.get("max_date"));
                    }
                ...
                // dataset
                .setTimePeriod((PropertyColumn) columnDate).setTimePeriodClass(Month.class)
                .addSerie(columnaQuantity, "quant.").addSerie(columnAmount)
                // plot
                .setShowShapes(true).setShowLines(true).setTimeAxisFormat(timeAxisFormat)
