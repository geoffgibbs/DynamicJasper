...
public class SubReportWithParameters2ReportTest extends BaseDjReportTest {
    ...
    public DynamicReport buildReport() throws Exception {
        ...
        drb.addColumn("State", "state", String.class.getName(), 30)
                ...
                .addColumn("Amount", "amount", Float.class.getName(), 70, true).addGroups(2).setMargins(5, 5, 20, 20)
        ...
        SubReportBuilder srb = new SubReportBuilder().setDynamicReport(drFooterSubreport, new ClassicLayoutManager())
                .addParameterFieldType("branch", "branch").setDataSource(DJConstants.DATA_SOURCE_ORIGIN_FIELD,
                        DJConstants.DATA_SOURCE_TYPE_COLLECTION, "statistics");
    ...
    private DynamicReport createFooterSubreport() throws Exception {
        ...
        DynamicReport dr = rb.addColumn("Area", "name", String.class.getName(), 100)
                ...
                .addColumn("Amount", "amount", Float.class.getName(), 50).addGroups(1).setMargins(5, 5, 20, 20)
                .setUseFullPageWidth(true).addParameter("branch", String.class.getName())
                .setTitle("\"Footer Subreport for branch \"+ $P{branch}", true) // Here we tell DJ that this title is a
                                                                                // jasper expression
                .build();
        return dr;
    }
