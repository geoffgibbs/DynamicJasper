...
public class CrosstabReportTest2 extends BaseDjReportTest {
    ...
    private DJCrosstab createCrosstab() {
        ...
        cb.setHeight(200).setWidth(500).setHeaderStyle(mainHeaderStyle)
                ...
                .setUseFullWidth(true).setColorScheme(4).setAutomaticTitle(true).setCellBorder(Border.THIN());
        ...
        DJCrosstabRow row = new CrosstabRowBuilder().setProperty("productLine", String.class.getName())
                .setHeaderWidth(100).setHeight(20).setTitle("Product Line").setShowTotals(true)
        ...
        row = new CrosstabRowBuilder().setProperty("id", Long.class.getName()).setHeaderWidth(100).setHeight(30)
                .setTitle("ID").setShowTotals(true).setTotalStyle(totalStyle).setTotalHeaderStyle(totalHeader)
                .setHeaderStyle(colAndRowHeaderStyle).build();
