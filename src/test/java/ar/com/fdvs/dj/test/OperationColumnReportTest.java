...
public class OperationColumnReportTest extends BaseDjReportTest {
    ...
    public DynamicReport buildReport() throws Exception {
        ...
        AbstractColumn columnAmount = ColumnBuilder.getNew().setColumnProperty("amount", Float.class.getName())
                .setTitle("Price /u").setWidth(new Integer(90)).setPattern("$ 0.00").setStyle(importeStyle)
                .setHeaderStyle(headerStyle).build();

        AbstractColumn operation = ColumnBuilder.getNew()
                .addColumnOperation(ColumnOperation.SUM,
                        new SimpleColumn[] { (SimpleColumn) columnaQuantity, (SimpleColumn) columnAmount })
                .setTitle("Price").setWidth(new Integer(90)).setPattern("$ 0.00").setStyle(importeStyle)
                .setHeaderStyle(headerStyle).build();
        ...
        gb2.setCriteriaColumn((PropertyColumn) columnBranch) // and we add the same operations for the columnAmount and
                ...
                .addFooterVariable(columnaQuantity, DJCalculation.SUM).addFooterVariable(operation, DJCalculation.SUM)
                .build();
